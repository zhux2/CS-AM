...
__udivmoddi4(du_int a, du_int b, du_int* rem)
{
    ...
    if (n.s.high == 0)
    {
        if (d.s.high == 0)
        {
             ...
             */
            if (rem)
                *rem = modu(n.s.low, d.s.low);
            return divu(n.s.low, d.s.low);
        }
        /* 0 X
         * ---
         * K X
    ...
    if (d.s.low == 0)
    {
        if (d.s.high == 0)
        {
             ...
             */
            if (rem)
                *rem = modu(n.s.high, d.s.low);
            return divu(n.s.high, d.s.low);
        }
        /* d.s.high != 0 */
        if (n.s.low == 0)
        {
            ...
            if (rem)
            {
                r.s.high = modu(n.s.high, d.s.high);
                r.s.low = 0;
                *rem = r.all;
            }
            return divu(n.s.high, d.s.high);
        }
        /* K K
         * ---
         * K 0
