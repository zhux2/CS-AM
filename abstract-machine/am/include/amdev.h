...
AM_DEVREG(14, LIGHT_LED,    WR, int x; char data);
AM_DEVREG(15, LIGHT_SEG,    WR, int x; char data);
AM_DEVREG(16, INPUT_SW,     RD, uint32_t sw);
AM_DEVREG(17, TXT_FBDRAW,   WR, int x, y; void *str; int len);
